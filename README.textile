...
Point your browser to "http://localhost:9200/_changes/":http://localhost:9200/_changes/ to see changes for all indices.
If you want to see changes only for one or a list of indices you can use "http://localhost:9200/foo,bar,baz/_changes/":http://localhost:9200/foo,bar,baz/_changes/.
...
If you want to see only changes after a given timestamp you can use "http://localhost:9200/_changes/?since=1330282941692":http://localhost:9200/_changes/?since=1330282941692. The timestamp again is a UNIX timestamp (in milliseconds).
